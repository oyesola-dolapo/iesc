...
export default function Landing() {
  return (
    <div className="w-full h-screen relative flex px-[.6rem] bg-black">
      <img
        src="/images/bg-img.webp"
        alt=""
        className="absolute top-0 left-0 w-full h-full object-cover opacity-[.6] z-[0]"
      />
      <div className="z-[0] m-auto text-center text-white">
        ...
        <button className="border-2 border-solid border-webColor px-8 py-3 mt-6 ">
          worship with us
        </button>
      </div>
    </div>
